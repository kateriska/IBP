...
# File: LBPGLCMexperiment.py - extraction of vectors based on LBP method
...
def vectorLBP(segmentation_type, color_type):
    ...
    for file in glob.glob(path_training):
        ...
        img = cv2.imread('segmented_img.jpg', 0) # load input grayscale img
...
# IMAGES FOR TESTING
    ...
    h = open("LBPGLCMtested.csv","w+") # csv file for tested images
